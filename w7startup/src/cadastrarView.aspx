<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/geral.Master" AutoEventWireup="true" CodeBehind="cadastrarView.aspx.cs" Inherits="global.cadastrarView" %>
    ...
    <div class="container">
        <div class="box-bg">
            ...
            <div class="content-register">
                <h3>Cadastre-se</h3>
                <asp:TextBox ID="txtName" runat="server" class="input-name" placeholder="Nome completo" ReadOnly="true"></asp:TextBox>
                <asp:Label ID="lblNome" runat="server" Text=""></asp:Label>
                <asp:TextBox ID="txtCpf" runat="server" class="input-cpf" placeholder="CPF" ReadOnly="true"></asp:TextBox>
                <asp:Label ID="lblCPF" runat="server" Text=""></asp:Label>
                <asp:TextBox ID="txtTell" runat="server" class="input-tell" placeholder="Telefone" ReadOnly="true"></asp:TextBox>
                <asp:Label ID="lblTell" runat="server" Text=""></asp:Label>
                <asp:LinkButton ID="AvancarPagina" class="button-advance" runat="server" OnClick="AvancarPagina_Click">
                    <span>Avançar</span>
