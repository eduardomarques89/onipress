...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select id, nome_fantasia, razao_social, cpf_cnpj, celular, email, CEP, endereco, bairro, estado, cidade from OniPres_empresa where [status] = 'Ativo'"></asp:SqlDataSource>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 w-100">
                        ...
                        <asp:DropDownList ID="ddlPlano" runat="server" CssClass="form-control shadow dropdown-menu-end" DataSourceID="sdsPlanos" DataTextField="nome" DataValueField="id">
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="sdsPlanos" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select id, nome from OniPres_planos"></asp:SqlDataSource>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:TextBox ID="txtCPFCNPJ" runat="server" MaxLength="18" onkeyup="formataCNPJ(this,event);" CssClass="form-control" Required></asp:TextBox>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Celular</label>
                        <asp:TextBox ID="txtCelular" runat="server" MaxLength="15" onkeyup="formataTelefone(this,event);" CssClass="form-control" Required></asp:TextBox>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:TextBox ID="txtCEP" runat="server" MaxLength="9" onkeyup="formataCEP(this,event);" OnTextChanged="txtCEP_TextChanged" CssClass="form-control" AutoPostBack="True" Required></asp:TextBox>
                    </div>
                    <div class="mb-3">
